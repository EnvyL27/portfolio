function content() {
    return (
        <>
            <section className="lg:px-36 bg-gray-100 text-white">
                <div
                ...
                >
                    <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                        <a
                            ...
                            href="/"
                        >
                            <svg className=" text-indigo-600" height="40px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a
                            ...
                            href="/"
                        >
                            <svg className="stroke-2 text-indigo-600" height="40px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M20 11.5H3V20.5C3 21.0523 3.44772 21.5 4 21.5H20C20.5523 21.5 21 21.0523 21 20.5V12.5C21 11.9477 20.5523 11.5 20 11.5Z" stroke="currentColor" />
                                <path d="M1.59998 7.40002L17.5747 1.58568C18.0937 1.39679 18.6676 1.66438 18.8565 2.18335L19.5405 4.06274C19.7294 4.58172 19.4618 5.15556 18.9428 5.34445L2.96806 11.1588L1.59998 7.40002Z" stroke="currentColor" />
                                <path d="M15.6954 2.26973L15.1841 6.71254" stroke="currentColor" />
                                <path d="M11.9366 3.6378L11.4253 8.08061" stroke="currentColor" />
                                <path d="M8.17785 5.00589L7.66654 9.4487" stroke="currentColor" />
                                <path d="M4.41906 6.37397L3.90775 10.8168" stroke="currentColor" />
                            </svg>
