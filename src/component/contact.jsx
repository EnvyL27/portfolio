...
function contact() {
    return (
        <>
            <section class="min-h-screen bg-gray-100 lg:flex z-10">
                <div class="flex flex-col justify-center w-full p-8 lg:bg-gray-100 lg:px-12 xl:px-32 lg:w-1/2">
                    <h1 class="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl">hire me.</h1>
                    ...
                    <div class="mt-6 md:mt-8">
                        <h3 class="font-medium text-gray-600 ">Follow me</h3>
