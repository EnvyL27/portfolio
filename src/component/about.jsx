                ...
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div className="w-3/5">
                        <div className="grid grid-cols-1">
                            ...
                            <p className="hidden lg:block text-xl text-gray-900 py-4"> I'm in the thick of my web development journey at <a href="https://www.polinema.ac.id/"><span className="text-indigo-600 font-medium">State Polytechnic of Malang</span></a>, currently cruising through my 7th semester. Beyond the world of coding and design, I'm a gamer at heart, there's something about those digital landscapes that sparks my creativity and keeps me exploring. I'm all about soaking up knowledge too; you'll often find me glued to video tutorials, fine-tuning my skills and staying ahead of the curve with the latest industry trends. Right now, I'm diving headfirst into the real-world web development scene through an internship at <a href="https://www.aio.co.id/"><span className="text-indigo-600 font-medium">PT Amerta Indah Otsuka</span></a>, where I'm weaving together the insights from my studies with hands-on experience!</p>
