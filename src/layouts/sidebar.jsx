...
const Sidebar = () => {
    return (
        <div className="fixed top-0 left-0 h-full w-1/12 bg-gray-100 text-black p-4">
            {/* Your sidebar content goes here */}
            <div className="absolute bottom-0 transform pb-16 pl-11">
                {/* <p className="text-center">farrel.ahmad.zaidan@gmail.com</p> */}
                <svg className='my-2' width="35px" height="35px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
